        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <form method="POST" class="loginForm">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="text" name="loginemail" value="<?php if(isset($_COOKIE['password']))  ?>" class="form-control" placeholder="enter your password" required>
                    </div>

                    <div class="form-group">
                        <label>Password</label> 
                        <input type="password" name="loginpassword" value="<?php if(isset($_COOKIE['password'])) ?>" class="form-control" placeholder="enter your password" required>
                    </div>
